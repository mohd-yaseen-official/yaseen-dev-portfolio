...
import { clonesConfig } from "../../../axiosConfig";
...
const Clones = () => {
    ...
    return (
        ...
        >
            <meta itemProp="name" content="Yaseen's UI Clone Projects" />
            <meta
                itemProp="description"
                content="Collection of UI clone projects demonstrating frontend development skills"
            />
                ...
                <AnimatePresence>
                    {isVisible && (
                        ...
                        >
                            ...
                            >
                                🚀 My{" "}
                                <span className="text-blue-500">UI Clones</span>
                            </motion.h1>
                            <motion.div
